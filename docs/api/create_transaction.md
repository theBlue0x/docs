...
*   _feeNQT_ is the fee (in NQT) for the transaction:
    ...
    *   2 BLX for [DGS Listing](marketplace.md#dgs-listing "The Blue0x API"), including 32 chars of name plust description. With 2 BLX additional fee for each 32 chars.
